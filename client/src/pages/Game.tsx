    ...
    <div className={`w-full h-screen min-h-[100dvh] relative overflow-hidden transition-colors duration-1000 bg-slate-950/60`}>
      ...
      <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-between p-4">
        ...
        <motion.div
          ...
          className={`flex flex-col md:flex-row items-stretch pointer-events-auto w-full max-w-6xl mx-auto metal-panel backdrop-blur-xl rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] border-2 border-slate-700/50 overflow-hidden hud-corners hud-tint-cyan ${chapter >= 4 ? 'hidden' : ''}`}
        >
          {/* Objective Section */}
        ...
        >
          {/* Stats Bar */}
          <div className="flex items-center gap-3 sm:gap-6 metal-panel backdrop-blur-md px-4 sm:px-6 py-3 rounded-2xl border border-white/5 shadow-2xl hud-corners hud-tint-cyan">
            <div id="lives-box">
              <LifeHearts />
            </div>
