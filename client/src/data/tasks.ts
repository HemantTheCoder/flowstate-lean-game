...
export const CONSTRUCTION_TASKS: TaskType[] = [
    ...
    { id: 'struct_1', title: 'Pour Foundation Zone A', description: 'Complete concrete pour for main lobby. Requires precise schedule coordination.', type: 'Structural', cost: 100, reward: 3500, difficulty: 4, leanTip: 'Foundation is a critical bottleneck. Ensure readiness before mobilizing.', constraints: ['approval', 'crew'], icon: { src: '/icons/tasks/task_pour_foundation.png', alt: 'Concrete foundation pour' } },
    { id: 'struct_2', title: 'Erect Steel Beams', description: 'Crane operation for 2nd floor framing. High resource intensity.', type: 'Structural', cost: 150, reward: 4000, difficulty: 5, leanTip: 'Just-in-Time delivery of steel avoids site congestion.', constraints: ['material'], icon: { src: '/icons/tasks/task_erect_steel_beams.png', alt: 'Steel beam erection with crane' } },
    { id: 'struct_3', title: 'Laying Subflooring', description: 'Install structural plywood sheeting for main floors.', type: 'Structural', cost: 30, reward: 1200, difficulty: 2, leanTip: 'Standardized work instructions reduce variability in install times.', icon: { src: '/icons/tasks/task_laying_subflooring.png', alt: 'Plywood subflooring installation' } },
    { id: 'struct_4', title: 'Roof Truss Assembly', description: 'Assemble timber trusses on-site for roof structure.', type: 'Structural', cost: 80, reward: 2500, difficulty: 3, leanTip: 'Pre-assembly is a form of off-site lean manufacturing.', constraints: ['weather'], icon: { src: '/icons/tasks/task_roof_truss.png', alt: 'Timber roof truss assembly' } },
    { id: 'struct_5', title: 'Ext. Wall Framing', description: 'Frame exterior load-bearing walls with 2x6 studs.', type: 'Structural', cost: 60, reward: 2000, difficulty: 3, leanTip: 'Limit inventory of lumber to match the pace of framing.', icon: { src: '/icons/tasks/task_wall_framing.png', alt: 'Exterior wall framing' } },
    { id: 'struct_6', title: 'Window Installation', description: 'Install weather-sealed glazing units.', type: 'Structural', cost: 90, reward: 2800, difficulty: 2, leanTip: 'Wait for structural settlement before final window fit-out.', constraints: ['material'], icon: { src: '/icons/tasks/task_window_install.png', alt: 'Window glazing installation' } },

    // SYSTEMS (Indoor, Rain Safe, Med Cost)
    { id: 'sys_1', title: 'Rough-in Plumbing', description: 'Install core sewage and water lines through foundations.', type: 'Systems', cost: 40, reward: 1800, difficulty: 3, leanTip: 'Multi-trade coordination prevents rework in MEP systems.', constraints: ['approval'], icon: { src: '/icons/tasks/task_plumbing.png', alt: 'Plumbing rough-in work' } },
    { id: 'sys_2', title: 'Electrical Wiring', description: 'Run main conduits and distribution wiring.', type: 'Systems', cost: 45, reward: 1900, difficulty: 3, leanTip: 'Visual management of conduit runs speeds up inspection.', icon: { src: '/icons/tasks/task_electrical_wiring.png', alt: 'Electrical wiring and conduit' } },
    { id: 'sys_3', title: 'HVAC Ductwork', description: 'Install ventilation and air handling ducts.', type: 'Systems', cost: 60, reward: 2200, difficulty: 3, leanTip: 'Large ductwork is bulky inventory; pull it only when needed.', icon: { src: '/icons/tasks/task_hvac_ductwork.png', alt: 'HVAC ductwork installation' } },
    { id: 'sys_4', title: 'Fire Sprinklers', description: 'Install overhead fire suppression piping.', type: 'Systems', cost: 55, reward: 2100, difficulty: 3, leanTip: 'Sequential installation avoids trade interference with HVAC.', icon: { src: '/icons/tasks/task_fire_sprinklers.png', alt: 'Fire sprinkler piping' } },
    { id: 'sys_5', title: 'Data Cabling', description: 'Run CAT6 networking and low-voltage control lines.', type: 'Systems', cost: 20, reward: 1400, difficulty: 1, leanTip: 'Batching cable pulls can lead to hidden rework if specs change.', icon: { src: '/icons/tasks/task_data_cabling.png', alt: 'Cat6 data cabling' } },

    // INTERIOR (Indoor, Rain Safe, Finishing)
    { id: 'int_1', title: 'Drywall Installation', description: 'Hang gypsum wallboards. Requires clear MEP rough-in.', type: 'Interior', cost: 25, reward: 1000, difficulty: 2, leanTip: 'A stable work environment is required for quality drywall finish.', icon: { src: '/icons/tasks/task_drywall.png', alt: 'Drywall installation' } },
    { id: 'int_2', title: 'Painting Walls', description: 'Apply high-durability primer and architectural finish.', type: 'Interior', cost: 15, reward: 800, difficulty: 1, leanTip: '5S cleanliness is vital before final architectural painting.', icon: { src: '/icons/tasks/task_painting.png', alt: 'Wall painting with roller' } },
    { id: 'int_3', title: 'Install Fixtures', description: 'Mount lighting, switches, and device plates.', type: 'Interior', cost: 50, reward: 1500, difficulty: 2, leanTip: 'Standardizing fixture types reduces supply chain complexity.', icon: { src: '/icons/tasks/task_fixtures.png', alt: 'Light fixture installation' } },
    { id: 'int_4', title: 'Flooring Install', description: 'Lay technical ceramic tiles and modular carpet.', type: 'Interior', cost: 70, reward: 2400, difficulty: 2, leanTip: 'Protect finished floors to avoid late-stage rework waste.', icon: { src: '/icons/tasks/task_flooring.png', alt: 'Floor tile installation' } },
    { id: 'int_5', title: 'Door Hanging', description: 'Install interior commercial door sets and hardware.', type: 'Interior', cost: 30, reward: 1100, difficulty: 1, leanTip: 'Last-minute door hanging prevents damage during main construction.', icon: { src: '/icons/tasks/task_door_hanging.png', alt: 'Interior door installation' } },

    // MANAGEMENT / PREP (0 Cost, for Supply Delay days)
    { id: 'prep_1', title: 'Inspect Formwork', description: 'Verify forms waiting for concrete.', type: 'Management', cost: 0, reward: 200, difficulty: 1, leanTip: 'Quality at source!', icon: { src: '/icons/tasks/task_inspect_formwork.png', alt: 'Formwork inspection' } },
