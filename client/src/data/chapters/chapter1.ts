...
export const WEEK_1_SCHEDULE: DayConfig[] = [
    ...
    },
    {
        ...
        dialogue: [
            ...
            { character: 'Engineer', text: "Don't just look busy. Do prep work for tomorrow. Clean the site.", emotion: 'neutral' }
        ],
        event: 'supply_delay'
    },
    {
        ...
        dialogue: [
            ...
            { character: 'Engineer', text: "Stop outdoor work. Move crew to the indoor electrical tasks. Flow around the obstacle.", emotion: 'happy' }
        ],
        event: 'rain'
    },
    {
        ...
        dialogue: [
            ...
            { character: 'Engineer', text: "If we start landscaping now, we'll just trample the mud. It's waste.", emotion: 'neutral' }
        ],
        event: 'decision_push'
    },
    {
        ...
        dialogue: [
            ...
            { character: 'Engineer', text: "Let's review our flow. Did we finish what we started?", emotion: 'neutral' }
        ],
        event: 'inspection'
    }
];
