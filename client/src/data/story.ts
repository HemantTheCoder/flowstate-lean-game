...
export const CHAPTER_1_INTRO: DialogueLine[] = [
    ...
    { character: 'Isha', text: "I scheduled everything in the plan, Rajiv. We’ll be fine if we just follow the dates.", emotion: 'happy' },
    { character: 'Mira', text: "Plans on paper are thin like rice paper. On site... it’s mud.", emotion: 'neutral' },
    { character: 'Architect', text: "Anil is right. A schedule isn't reality. We need to visualize the actual constraints.", emotion: 'neutral' },
